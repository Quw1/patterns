...
namespace AbstractFactory
{
    ...
    //ConcreteProductB3
    public class MersedezEngine : Engine
    {
        public override void GetPower()
        {
            Console.WriteLine("Mersedez Engine");
        }
    }
    ...
    // ConcreteFactory3
    public class MersedezFactory : ICarFactory
    {
        // from CarFactory
        Car ICarFactory.CreateCar()
        {
    ...
    class AbstractFactoryApp
    {
        static void Main(string[] args)
        {
            ...
            carFactory = new MersedezFactory();
